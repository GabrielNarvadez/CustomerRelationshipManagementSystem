...
echo ^    ^<title^>{%% block title %%}SmartConnect{%% endblock %%}^</title^> >> templates\base.html
...
echo ^        ^<h1^>Welcome to SmartConnect^</h1^> >> templates\base.html
echo ^    ^</header^> >> templates\base.html
